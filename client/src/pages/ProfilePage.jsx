...
const ProfilePage = () => {
  ...
  // Authenticated user data and profile update handler
  ...
  const handleSubmit = async (e) => {
    ...
    // Update only name and bio if no image is selected
    if (!selectedImg) {
    ...
    // Convert selected image to Base64 before uploading
    ...
    reader.onload = async () => {
      ...
      // Update profile image along with name and bio
      await updateProfile({
